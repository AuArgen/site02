...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="home ">
      <br>
      <div class="text-center"><a href="./php/productsAdds.php?type=2"><button type="button" class="btn btn-outline-success" style="width:90%;font-size:20px">Добавить галерея +</button></a></div>
      <br>  
